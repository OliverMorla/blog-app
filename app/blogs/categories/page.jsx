...
const Blogs = async ({ searchParams: { query } }) => {
    ...
    const res = await fetch(process.env.NEXT_BLOG_CATEGORIES_URL, GET)
    const categories = await res.json()

    const filtedBlogs = await fetch(process.env.NEXT_BLOG_CATEGORIES_URL + `/search?query=${query}`, GET)
